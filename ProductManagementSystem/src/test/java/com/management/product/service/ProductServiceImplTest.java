...
public class ProductServiceImplTest extends DataServiceImplTest<Product>{
    ...
    public ProductServiceImplTest() {
        this.product1 = new Product("TestProduct1", "Manufacturer1", "Description1", 101);
        this.product1.setId(1L);
        this.product2 = new Product("TestProduct2", "Manufacturer2", "Description2", 202);
    ...
    public void updateTest() throws Exception {
        Product productForUpdate = new Product("Product For Update", 1111);
